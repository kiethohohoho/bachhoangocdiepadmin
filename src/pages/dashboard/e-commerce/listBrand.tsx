...
ListBrand.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function ListBrand() {
  ...
  const [currentData, setCurrentData] = useState<IBrand>();
    ...
    <>
      ...
      >
        <Box sx={{ ...style, borderRadius: 5 }}>
          <BrandEditForm handleReload={handleReload} isEdit={isEdit} handleClose={handleClose} currentData={currentData}/>
        </Box>
      </Modal>
