...
ListHistory.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
    ...
    <>
      ...
      >
        <Box sx={{ ...style, borderRadius: 5 }}>
          <Scrollbar>
            <EventEditFrom type='history' handleClose={handleClose} isEdit={isEdit} current={isEdit ? idRow : undefined}/>
          </Scrollbar>
        </Box>
      </Modal>
