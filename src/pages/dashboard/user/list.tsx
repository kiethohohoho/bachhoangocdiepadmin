...
import { getUsers } from 'src/api/ortherEcom';
// routes
...
const STATUS_OPTIONS = ['all', 'Đang hoạt động', 'Bị cấm'];
...
export default function UserListPage() {
  ...
  useEffect(() => {
    getUsers().then((res) => {
      setTableData(res.data.users.Data)
    });
  }, []);
  ...
  return (
    <>
      <Head>
        <title> Người dùng | Bách hóa Ngọc Diệp</title>
      </Head>
